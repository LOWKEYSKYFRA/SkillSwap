...
const SignupScreen = () =>  { 
    const [newEmail, setNewEmail] =
     ...
     useState('');
      const blImage =require("../../assets/images/cooking.jpg")

  const handleSignup = () => {  
  //sign logic will go there later
  console.log('Sign up with:', newEmail, newPassword);//Placeholder log
...
export default function App(){
    return(
         <Stack.Navigator screenOptions={{headerShown:false}} initialRouteName='Sign up'>
